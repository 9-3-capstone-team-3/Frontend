...
function AllStepsSimVids() {
  ...
  const nextStep = () => {
    ...
    return (
      <div className="App">
        ...
        {step === 19 && <CreateBranch nextStep={nextStep} />}
        {step === 20 && <ForkRepo nextStep={nextStep} />}
        {step === 21 && <CloneRepo nextStep={nextStep}  />}
        {step === 22 && <CreateBranch nextStep={nextStep} />}
        {step === 23 && <MakeChanges nextStep={nextStep} />}
        {step === 24 && <CommitChanges nextStep={nextStep} />}
        {step === 25 && <PushRepo nextStep={nextStep} />}
        {step === 26 && <CreatePullRequest nextStep={nextStep} />}
        {step === 26 && showPopup && 
        <div className="popup">
  ...
  export default AllStepsSimVids;